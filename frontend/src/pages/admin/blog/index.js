...
import { PostNewsletter } from 'src/sections/admin/blog/post-newsletter';
import { PostCard } from 'src/sections/admin/blog/post-card';
import { ARROW_LEFT, ARROW_RIGHT } from 'src/settings/icon-constants';
      ...
      >
        <Container maxWidth={settings.stretch ? false : 'xl'}>
          ...
          >
            ...
            <Button
              component={RouterLink}
              href={paths.admin.blog.postCreate}
              variant="contained"
            >
              New Post
            </Button>
          ...
          >
            <Button
              disabled
              startIcon={<SvgIcon>{ARROW_LEFT}</SvgIcon>}
            >
              Newer
            </Button>
            <Button endIcon={<SvgIcon>{ARROW_RIGHT}</SvgIcon>}>Older posts</Button>
          </Stack>
          <Box sx={{ mt: 8 }}>
            <PostNewsletter />
          </Box>
