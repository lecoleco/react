...
import { fileToBase64 } from 'src/helpers/file-to-base64';
import { DOTS_HORIZONTAL } from 'src/settings/icon-constants';
        ...
        <Container maxWidth={settings.stretch ? false : 'xl'}>
          ...
          >
            ...
            >
              ...
              <Button
                component={RouterLink}
                href={paths.admin.blog.postDetails}
                variant="contained"
              >
                Publish changes
              </Button>
              <IconButton>
                <SvgIcon>{DOTS_HORIZONTAL}</SvgIcon>
              </IconButton>
            </Stack>
          </Card>
          <Stack spacing={3}>
