...
import { InvoiceListContainer } from 'src/sections/admin/invoice/invoice-list-container';
import { InvoiceListSidebar } from 'src/sections/admin/invoice/invoice-list-sidebar';
import { InvoiceListSummary } from 'src/sections/admin/invoice/invoice-list-summary';
import { InvoiceListTable } from 'src/sections/admin/invoice/invoice-list-table';
import { FILTER_FUNNEL, PLUS } from 'src/settings/icon-constants';
            ...
            <Stack spacing={4}>
              ...
              >
                ...
                >
                  <Button
                    color="inherit"
                    startIcon={<SvgIcon>{FILTER_FUNNEL}</SvgIcon>}
