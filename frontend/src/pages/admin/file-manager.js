...
import { FileUploader } from 'src/sections/admin/file-manager/file-uploader';
import { ItemDrawer } from 'src/sections/admin/file-manager/item-drawer';
import { ItemList } from 'src/sections/admin/file-manager/item-list';
import { ItemSearch } from 'src/sections/admin/file-manager/item-search';
import { StorageStats } from 'src/sections/admin/file-manager/storage-stats';
import { UPLOAD } from 'src/settings/icon-constants';
              ...
              >
                ...
                >
                  <Button
                    ...
                    startIcon={<SvgIcon>{UPLOAD}</SvgIcon>}
                    variant="contained"
                  >
                    Upload
                  </Button>
