...
import { AnalyticsStats } from 'src/sections/admin/analytics/analytics-stats';
import { AnalyticsMostVisited } from 'src/sections/admin/analytics/analytics-most-visited';
import { AnalyticsSocialSources } from 'src/sections/admin/analytics/analytics-social-sources';
import { AnalyticsTrafficSources } from 'src/sections/admin/analytics/analytics-traffic-sources';
import { AnalyticsVisitsByCountry } from 'src/sections/admin/analytics/analytics-visits-by-country';

import { ARROW_RIGHT, PLUS } from 'src/settings/icon-constants';
            ...
            >
              <AnalyticsStats
                action={
                  <Button
                    color="inherit"
                    endIcon={<SvgIcon>{ARROW_RIGHT}</SvgIcon>}
                    size="small"
                  >
                    See sources
                  </Button>
